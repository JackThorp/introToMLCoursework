function [ decision_tree ] = getDecisionTree(emotion, datax, datay)
...
%   generate the decision tree.
    ...
    binary_targets = datay;
    for i=1:length(binary_targets),
        binary_targets(i) = (binary_targets(i) == emotion);
    end
    attributes = (1:length(datax(1,:)));
    decision_tree = decisionTreeLearning(datax, attributes, binary_targets); 
end
